...
import com.galosanchez.appuberclone.receivers.AcceptReceiver;
import com.galosanchez.appuberclone.receivers.CancelReceiver;
...
public class FirebaseMessagingClient extends FirebaseMessagingService {
    ...
    private void showNotificationApiOreoActions(String title, String body, String idClient) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(this,NOTIFICATION_CODE, acceptIntent, PendingIntent.FLAG_UPDATE_CURRENT);
